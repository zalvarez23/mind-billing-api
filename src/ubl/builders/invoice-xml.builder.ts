...
import {
  ...
  InvoiceBuildItem,
  InvoiceTotals,
} from '../interfaces/invoice-build-input.interface';

const IGV_RATE = 0.18;

/** Catálogo 05: ID=1000 (UN/ECE 5153), TaxTypeCode=VAT (código internacional IGV). */
...
export class InvoiceXmlBuilder {
  build(input: InvoiceBuildInput): { xml: string; totals: InvoiceTotals } {
...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
  ...
  <cbc:InvoiceTypeCode listID="${input.tipoOperacion}" listAgencyName="PE:SUNAT" listName="Tipo de Documento" listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo01">01</cbc:InvoiceTypeCode>
